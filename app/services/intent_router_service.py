...
class IntentRouterService:
    ...
    def classify_intent(cls, user_prompt: str) -> QueryIntentClassification:
        ...
        system_instruction = (
            ...
            "1. sql_sub_query: Extract ONLY the target person, item, and hard data attributes (e.g., shipping status, tracking, total spend) for the live database.\n"
            "2. rag_sub_query: Extract the concepts, rules, policies, AND any abstract classifications or tiers (e.g., 'VIP tier', 'loyalty status', 'warranties') to look up in the documents. DO NOT put abstract policy concepts into the sql_sub_query. Strip out specific customer names or order numbers.\n\n"
