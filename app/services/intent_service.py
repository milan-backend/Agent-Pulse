...
def analyze_user_query_intent(user_prompt: str, registry_candidates: List[Dict[str, Any]]) -> IntentAnalysisSchema:
    ...
    system_instruction = (
        ...
        "🎯 MISSION:\n"
        "Analyze human user questions perfectly and analyze the question perfectly because your analyzing is matter because your user question analyze send to the plannar AI so it will fetch correct chunks and against the provided Top Registry Candidates.\n"
