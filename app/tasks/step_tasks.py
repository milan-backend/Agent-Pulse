...
from app.services.generation_service import GenerationService  # 🚀 NEW GENERATION ARCHITECTURE SERVICE
               ...
               # =====================================================================
                ...
                if retrieval_blueprint and retrieval_blueprint.selected_document_ids:
                    ...
                    search_filters = {
                        ...
                        "target_navigation_nodes": target_nav_nodes,
                    ...
                    # Populate influencing list for telemetry
                ...
                # =====================================================================
                # 🚀 GENERATION ARCHITECTURE SERVICE SYNTHESIS
                # =====================================================================
                gen_service = GenerationService()
                output = gen_service.synthesize_response(
                    user_prompt=prompt,
                    intent_strategy=intent_strategy,
                    recovered_chunks=reconstructed_sections
                )
