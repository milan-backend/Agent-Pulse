  ...
  async function fetchAgent() {
    try {
      ...
      const normalizedAgent = {
        ...
        mission_count: Number(response?.mission_count ?? response?.stats?.mission_count ?? 0),
        total_cost: Number(response?.total_cost ?? response?.stats?.total_cost ?? 0),
